...
(function ($) {
    $.fn.checkout = function () { // eslint-disable-line
        ...
        /**
         * Submit payment
         * @param {Object} paymentForm form values
            ...
            updateStage: function () {
                ...
                if (stage === 'shipping') {
                    ...
                    if ($('.data-checkout-stage').data('customer-type') === 'registered') {
                        ...
                        if ($('.payment-information').data('payment-method-id') === 'CREDIT_CARD') {
                            if (!($('.payment-information').data('is-new-payment'))) {
                                ...
                                paymentProductId = $('.saved-payment-instrument.selected-payment #paymentProductId').val();
                    ...
                    if ($('.payment-information').data('payment-method-id') === 'CREDIT_CARD' || cvvCode) {
                        ...
                        paymentForm += '&dwfrm_billing_paymentMethod=' + $(paymentInfoSelector).val();
                        $.ajax({
                            ...
                            success: function (context) {
                                ...
                                if (cvvCode) {
                                    ...
                                    var expiryMonth = $('#expirationMonth').val().length === 1 ? '0' + $('#expirationMonth').val() : $('#expirationMonth').val();
                                    var expiryYear = $('#expirationYear').val().substring(2);
                                    cardDetails = {
                                ...
                                var paymentDetails = {
                                    totalAmount: $('input[name=totalAmount]').val().replace(/[^0-9]+/g, ''),
                                ...
                                if (cvvCode) {
                                    billingHelpers.createEncryptedCustomerInputForCvv(session, cardDetails, function (encryptedString) {
